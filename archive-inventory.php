...
?>
		...
		<?php //echo get_the_term_list( $post->ID, 'inventory_type', '<div class="post-group"><span class="post-tags">', '</span><span class="post-tags">', '</span></div>' );?> 
	 <ul class="equipment-rental">
...
$wp_query->query('post_type=inventory' . '&paged=' . $paged . '&posts_per_page=9&orderby=title&order=ASC');?>
