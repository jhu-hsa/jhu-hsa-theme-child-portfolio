...
?> 
  ...
  <?php 
				...
				<p><strong>View:</strong> <strong>Creative Tech</strong> |
                 <a  href="<?php bloginfo('url'); ?>/category/events/?sort=datedsc">Events</a> | 
				 <a  href="<?php bloginfo('url'); ?>/category/profiles/?sort=dscedsc">Member Profiles</a> |  
